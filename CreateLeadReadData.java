...
import io.github.bonigarcia.wdm.WebDriverManager;
	public class CreateLeadReadData extends BaseLeadReadData {
		
		//Here we are reading data from excel and passing data to data provider
		
		@DataProvider(name="CreateLeadReadData")
		...
		@Test(dataProvider="CreateLeadReadData") //Need to add invocation count
		
		public void createNewLead(String companyname,String firstname,String lastname) {
